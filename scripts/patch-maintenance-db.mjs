/**
 * Active maintenance dans site_content (usage ponctuel / debug).
 * node scripts/patch-maintenance-db.mjs [--off]
 */
...
console.log(enabled ? 'Maintenance activée dans Supabase.' : 'Maintenance désactivée dans Supabase.')
console.log('Clés payload:', Object.keys(payload).join(', '))
